...
public:
    ...
    void setupUi(QWidget *user_form)
    {
        ...
        search_status->setGeometry(QRect(139, 360, 5, 31));
        ...
        reserve_status->setGeometry(QRect(140, 320, 5, 31));
        ...
        out_status->setGeometry(QRect(139, 280, 5, 31));
        ...
        export_status->setGeometry(QRect(139, 430, 5, 31));
        in_status = new QLabel(user_form);
        in_status->setObjectName(QStringLiteral("in_status"));
        in_status->setGeometry(QRect(140, 238, 5, 31));
