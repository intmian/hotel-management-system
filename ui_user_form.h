...
public:
    ...
    QLineEdit *setting_sourse_pwd;
    QLabel *label_22;
    QLabel *label_23;
    QLabel *label_24;
    QLineEdit *settting_sourse;
    QLineEdit *setting_sourse_account;
    QPushButton *setting_sourse_but;
    QPushButton *close;
    QPushButton *hide;
    QLabel *back;
    QLabel *room_status;
...
"font: 20pt \"\345\271\274\345\234\206\";"));
        ...
        export_export->setGeometry(QRect(200, 160, 151, 41));
...
"}"));
        ...
        setting_admin_but->setGeometry(QRect(115, 150, 131, 31));
        ...
        setting_add_room_type_text->setGeometry(QRect(100, 200, 171, 31));
        ...
        setting_room_type->setGeometry(QRect(360, 100, 201, 31));
        setting_sourse_pwd = new QLineEdit(setting_tab);
        setting_sourse_pwd->setObjectName(QStringLiteral("setting_sourse_pwd"));
        setting_sourse_pwd->setGeometry(QRect(200, 320, 201, 31));
        ...
        settting_sourse = new QLineEdit(setting_tab);
        settting_sourse->setObjectName(QStringLiteral("settting_sourse"));
        settting_sourse->setGeometry(QRect(100, 280, 171, 31));
        setting_sourse_account = new QLineEdit(setting_tab);
        setting_sourse_account->setObjectName(QStringLiteral("setting_sourse_account"));
        setting_sourse_account->setGeometry(QRect(390, 280, 171, 31));
        setting_sourse_but = new QPushButton(setting_tab);
        setting_sourse_but->setObjectName(QStringLiteral("setting_sourse_but"));
        setting_sourse_but->setGeometry(QRect(240, 360, 141, 31));
...
"\346\210\277\351\227\264\345\217\267", Q_NULLPTR));
        ...
        export_export->setText(QApplication::translate("user_form", "\344\270\200\351\224\256\345\257\274\345\207\272excel", Q_NULLPTR));
        ...
        setting_confirm_text->setText(QApplication::translate("user_form", "\346\267\273\345\212\240\346\210\277\351\227\264\347\261\273\345\236\213\346\210\226\346\224\271\345\217\230\347\261\273\345\236\213\347\232\204\344\273\267\346\240\274", Q_NULLPTR));
        ...
        setting_sourse_but->setText(QApplication::translate("user_form", "\344\277\256\346\224\271\351\205\215\347\275\256", Q_NULLPTR));
